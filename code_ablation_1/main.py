...
def getArgs():
    ...
    parser.add_argument("-l", help = "input the path to save logs", dest = "log_path", type = str, default = "../../output/gavin23+vitas1_10min/")
    parser.add_argument("-o", help = "input the path to save results", dest = "res_path", type = str, default = "../../output/gavin23+vitas1_10min/result/")
...
def init_constant(config_id):
    ...
    Constant.CHROME_PATH = "../chrome/chromedriver_103"
